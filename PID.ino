...
#define SAMPLE_PERIOD_US 50//50    //sets the PID loop frequency (too low and the code doesn't work)
...
float kp=0.1, ki=10000, kd=0;
uint16_t setpoint = volts2int(1.0, ADC_BITS); //default setpoint (voltage it reads)
